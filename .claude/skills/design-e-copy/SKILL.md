---
name: design-e-copy
description: "Lo stile e la voce dei testi collaudati nell'app OFA Polimi Prep dell'utente (mobile-first, stile Duolingo): pulsanti 3D premibili, un colore per significato, un'azione principale per schermata, testo grande, feedback che festeggia i successi e resta neutro sugli errori, tema scuro, accessibilità verificata, testi in italiano brevi e letterali con il tu, maiuscola solo iniziale, un termine per concetto. Usala quando l'utente progetta o sistema un'interfaccia, un'app, una pagina, un componente o un artifact, o scrive e rivede testi dell'interfaccia (pulsanti, errori, stati vuoti, microcopy). Va usata insieme a giudizio-di-design: quella decide che cosa fare e come in base al contesto; questa fornisce le ricette collaudate come punto di partenza, da adattare o abbandonare quando il contesto lo chiede."
---
