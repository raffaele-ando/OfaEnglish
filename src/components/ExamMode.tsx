...
export default function ExamMode({ onComplete, onExit }: ExamModeProps) {
  ...
  if (!hasStarted) {
    return (
      <div className="flex flex-col items-center justify-center h-full w-full p-4 sm:p-6 text-center bg-white dark:bg-[#1E293B] sm:rounded-[32px] sm:border-2 sm:border-gray-200 dark:sm:border-[#334155] overflow-hidden shadow-sm transition-colors duration-300">
  ...
  if (isFinished) {
    ...
    return (
      <div className="flex flex-col h-full w-full overflow-y-auto scrollbar-hide bg-white dark:bg-[#1E293B] sm:rounded-[32px] sm:border-2 sm:border-gray-200 dark:sm:border-[#334155] shadow-sm p-4 sm:p-6 text-center transition-colors duration-300">
